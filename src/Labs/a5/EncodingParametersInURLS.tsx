...
function EncodingParametersInURLs() {
  ...
  return (
    <div>
      ...
      <a className="btn btn-primary wd-button-space" href={`${API_BASE}/a5/add/${a}/${b}`}>
        Add {a} + {b}
      </a>
      <a className="btn btn-danger wd-button-space" href={`${API_BASE}/a5/subtract/${a}/${b}`}>
        Subtract {a} - {b}
      </a>
      <a className="btn lab-green-button wd-button-space" href={`${API_BASE}/a5/multiply/${a}/${b}`}>
        Multiply {a} * {b}
      </a>
      <a className="btn lab-yellow-button wd-button-space" href={`${API_BASE}/a5/divide/${a}/${b}`}>
        Divide {a} % {b}
      </a>
